...
const { URLWithLegacySupport, format, URLSearchParams, defaultBase } = __webpack_require__(/*! ./src/url */ "./node_modules/iso-url/src/url-browser.js");
...
function format(obj) {
    ...
    if (!(obj instanceof URL)) {
        const userPass = obj.username && obj.password ?
...
/***/ "./src/declarations/custom_greeting_backend/custom_greeting_backend.did.js":
/*!*********************************************************************************!*\
  !*** ./src/declarations/custom_greeting_backend/custom_greeting_backend.did.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/custom_greeting_backend/index.js":
/*!***********************************************************!*\
  !*** ./src/declarations/custom_greeting_backend/index.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   custom_greeting_backend: () => (/* binding */ custom_greeting_backend),
/* harmony export */   idlFactory: () => (/* reexport safe */ _custom_greeting_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _custom_greeting_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./custom_greeting_backend.did.js */ "./src/declarations/custom_greeting_backend/custom_greeting_backend.did.js");
...
const createActor = (canisterId, options = {}) => {
    ...
    return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_custom_greeting_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
        agent,
        canisterId,
        ...options.actorOptions,
    });
};
const custom_greeting_backend = createActor(canisterId);
...
"use strict";
/*!****************************************************!*\
  !*** ./src/custom_greeting_frontend/src/index.jsx ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_custom_greeting_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/custom_greeting_backend */ "./src/declarations/custom_greeting_backend/index.js");

window.addEventListener("load", async () => {
    const amount = await _declarations_custom_greeting_backend__WEBPACK_IMPORTED_MODULE_0__.custom_greeting_backend.getBalance();
...
document.querySelector("form").addEventListener("submit", async (e) => {
    ...
    await _declarations_custom_greeting_backend__WEBPACK_IMPORTED_MODULE_0__.custom_greeting_backend.topUp(inputAmount);
    await _declarations_custom_greeting_backend__WEBPACK_IMPORTED_MODULE_0__.custom_greeting_backend.withdraw(withdrawAmount);
...
document.getElementById("passbookButton").addEventListener("click", async () => {
    const transactionList = await _declarations_custom_greeting_backend__WEBPACK_IMPORTED_MODULE_0__.custom_greeting_backend.getTransactionList();
    const transactionListUl = document.getElementById("transactionList");
    transactionListUl.innerHTML = "";
    if (transactionList.length === 0) {
        const transactionItem = document.createElement("li");
        transactionItem.innerText = "No transactions available.";
        transactionListUl.appendChild(transactionItem);
    }
    else {
        transactionList.forEach((transaction) => {
            const transactionItem = document.createElement("li");
            transactionItem.innerText = `${transaction.transactionType} - ₹${transaction.amount} on ${transaction.date}`;
            transactionListUl.appendChild(transactionItem);
        });
    }
});
